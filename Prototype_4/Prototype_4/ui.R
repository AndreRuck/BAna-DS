...
shinyUI(fluidPage(
    navbarPage("Preddly",
                                     ...
                                     sidebarLayout(
                                       ...
                                       tabPanel("Specific Needs",
                                                ...
                                                sidebarLayout(
                                                  ...
                                                  mainPanel(
                                                    p(code("*SNAP= supplemental nutrition assistance programm")),
                                                    p(code("**TANF= Temporary Assistance for Needy Families")),
                                                    plotOutput("pl"),
                                                    br(),br(),
                                                    plotOutput("pl1"),
                                                    br(),br(),
               ...
               tabPanel("Optimize YOUR Life",
                        navlistPanel(
                          tabPanel("Register",
                                   titlePanel("Please complete registration to save up your predictions
                        ...
                        tabPanel("Comparison",
                                 h1("Fill up in order to compare"),
                                 br(),
                                 sidebarLayout(
                                   sidebarPanel(
                                     titlePanel("Profil 1"),
