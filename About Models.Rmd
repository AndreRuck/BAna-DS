...
We used unsupervised learning (k nearest neighbour) to create an additional variable which increased R^2 from 0.75 to 0.90 and reduced RMSE by more than 60%
